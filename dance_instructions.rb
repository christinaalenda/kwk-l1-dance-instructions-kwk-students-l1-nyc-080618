...
def base_footwork  
  ...
  puts "Return right foor to the ground"
  #finish step 3
end
...
def lasso
  ...
  puts "Raise right forearm so that it points straight up, and whip it in small circls to the beat of the song, as if you were a cowboy holding a rope lasso. This movement is repeated eight times as well."
  puts "Do this 7 more times!"
end
